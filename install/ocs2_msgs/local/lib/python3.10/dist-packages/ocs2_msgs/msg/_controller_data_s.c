...
bool ocs2_msgs__msg__controller_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ocs2_msgs.msg._controller_data.ControllerData", full_classname_dest, 45) == 0);
  }
  ocs2_msgs__msg__ControllerData * ros_message = _ros_message;
  {  // data
...
PyObject * ocs2_msgs__msg__controller_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ocs2_msgs.msg._controller_data");
