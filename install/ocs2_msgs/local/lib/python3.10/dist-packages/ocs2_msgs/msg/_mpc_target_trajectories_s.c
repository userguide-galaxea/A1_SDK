...
bool ocs2_msgs__msg__mpc_target_trajectories__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ocs2_msgs.msg._mpc_target_trajectories.MpcTargetTrajectories", full_classname_dest, 60) == 0);
  }
  ocs2_msgs__msg__MpcTargetTrajectories * ros_message = _ros_message;
  {  // time_trajectory
...
{
  /* NOTE(esteve): Call constructor of MpcTargetTrajectories */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ocs2_msgs.msg._mpc_target_trajectories");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MpcTargetTrajectories");
