...
bool ocs2_msgs__msg__mpc_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ocs2_msgs.msg._mpc_state.MpcState", full_classname_dest, 33) == 0);
  }
  ocs2_msgs__msg__MpcState * ros_message = _ros_message;
  {  // value
...
PyObject * ocs2_msgs__msg__mpc_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ocs2_msgs.msg._mpc_state");
