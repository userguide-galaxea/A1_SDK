...
{
  new (message_memory) ocs2_msgs::srv::Reset_Request(_init);
}

void Reset_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ocs2_msgs::srv::Reset_Request *>(message_memory);
  typed_message->~Reset_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Reset_Request_message_member_array[2] = {
  {
    "reset",  // name
    ...
    offsetof(ocs2_msgs::srv::Reset_Request, reset),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ocs2_msgs::srv::Reset_Request, target_trajectories),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Reset_Request_message_members = {
  "ocs2_msgs::srv",  // message namespace
  "Reset_Request",  // message name
  2,  // number of fields
  sizeof(ocs2_msgs::srv::Reset_Request),
...
{
  return &::ocs2_msgs::srv::rosidl_typesupport_introspection_cpp::Reset_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ocs2_msgs, srv, Reset_Request)() {
  return &::ocs2_msgs::srv::rosidl_typesupport_introspection_cpp::Reset_Request_message_type_support_handle;
}
...
void Reset_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) ocs2_msgs::srv::Reset_Response(_init);
}

void Reset_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ocs2_msgs::srv::Reset_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Reset_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ocs2_msgs::srv::Reset_Response, done),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Reset_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(ocs2_msgs::srv::Reset_Response),
...
{
  return &::ocs2_msgs::srv::rosidl_typesupport_introspection_cpp::Reset_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ocs2_msgs, srv, Reset_Response)() {
  return &::ocs2_msgs::srv::rosidl_typesupport_introspection_cpp::Reset_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Reset_service_members = {
  "ocs2_msgs::srv",  // service namespace
  "Reset",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<ocs2_msgs::srv::Reset>()
...
get_service_type_support_handle<ocs2_msgs::srv::Reset>()
{
  ...
  auto service_type_support =
    &::ocs2_msgs::srv::rosidl_typesupport_introspection_cpp::Reset_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ocs2_msgs, srv, Reset)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<ocs2_msgs::srv::Reset>();
}
