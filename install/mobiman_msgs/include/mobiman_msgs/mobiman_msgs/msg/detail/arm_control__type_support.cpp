...
{
  new (message_memory) mobiman_msgs::msg::ArmControl(_init);
}

void ArmControl_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mobiman_msgs::msg::ArmControl *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArmControl_message_member_array[7] = {
  {
    ...
    offsetof(mobiman_msgs::msg::ArmControl, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mobiman_msgs::msg::ArmControl, p_des),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mobiman_msgs::msg::ArmControl, v_des),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mobiman_msgs::msg::ArmControl, kp),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mobiman_msgs::msg::ArmControl, kd),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mobiman_msgs::msg::ArmControl, t_ff),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mobiman_msgs::msg::ArmControl, mode),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArmControl_message_members = {
  ...
  7,  // number of fields
  sizeof(mobiman_msgs::msg::ArmControl),
...
get_message_type_support_handle<mobiman_msgs::msg::ArmControl>()
{
  return &::mobiman_msgs::msg::rosidl_typesupport_introspection_cpp::ArmControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mobiman_msgs, msg, ArmControl)() {
  return &::mobiman_msgs::msg::rosidl_typesupport_introspection_cpp::ArmControl_message_type_support_handle;
}
