    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mobiman_msgs.msg.CameraDetection')
            logger.debug(
            ...
            from mobiman_msgs.msg import Mask
...
class CameraDetection(metaclass=Metaclass_CameraDetection):
    ...
    _fields_and_field_types = {
        ...
        'mask': 'mobiman_msgs/Mask',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['sensor_msgs', 'msg'], 'Image'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['mobiman_msgs', 'msg'], 'Mask'),  # noqa: E501
    )
