...
class Mask(metaclass=Metaclass_Mask):
    ...
    _fields_and_field_types = {
        ...
        'width': 'uint16',
        'data': 'sequence<uint8>',
        'mask_types': 'sequence<uint8>',
        'instance_description': 'sequence<string>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.mask_types = array.array('B', kwargs.get('mask_types', []))
        self.instance_description = kwargs.get('instance_description', [])
    ...
    def __eq__(self, other):
        ...
        if self.data != other.data:
            return False
        if self.mask_types != other.mask_types:
            return False
        if self.instance_description != other.instance_description:
            return False
        return True
    ...
    @builtins.property
    def mask_types(self):
        """Message field 'mask_types'."""
        return self._mask_types

    @mask_types.setter
    def mask_types(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'mask_types' array.array() must have the type code of 'B'"
            self._mask_types = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= 0 and val < 256 for val in value)), \
                "The 'mask_types' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._mask_types = array.array('B', value)

    @builtins.property
    def instance_description(self):
        """Message field 'instance_description'."""
        return self._instance_description

    @instance_description.setter
    def instance_description(self, value):
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'instance_description' field must be a set or sequence and each value of type 'str'"
        self._instance_description = value
