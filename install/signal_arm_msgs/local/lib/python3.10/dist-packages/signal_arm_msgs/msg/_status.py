...
class Metaclass_Status(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from signal_arm_msgs.msg import MotorError
            if MotorError.__class__._TYPE_SUPPORT is None:
                MotorError.__class__.__import_type_support__()
...
class Status(metaclass=Metaclass_Status):
    ...
    _fields_and_field_types = {
        ...
        'motor_errors': 'sequence<signal_arm_msgs/MotorError>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.UnboundedString()),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['signal_arm_msgs', 'msg'], 'MotorError')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_errors = kwargs.get('motor_errors', [])
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 all(isinstance(v, MotorError) for v in value) and
                 True), \
                "The 'motor_errors' field must be a set or sequence and each value of type 'MotorError'"
