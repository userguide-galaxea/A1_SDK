...
#ifndef SIGNAL_ARM_MSGS__MSG__DETAIL__CONTROL__TRAITS_HPP_
#define SIGNAL_ARM_MSGS__MSG__DETAIL__CONTROL__TRAITS_HPP_
...
inline void to_yaml(
  const signal_arm_msgs::msg::Control & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const signal_arm_msgs::msg::Control & msg)
{
  return signal_arm_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<signal_arm_msgs::msg::Control>()
{
  return "signal_arm_msgs::msg::Control";
}

template<>
inline const char * name<signal_arm_msgs::msg::Control>()
{
  return "signal_arm_msgs/msg/Control";
}

template<>
struct has_fixed_size<signal_arm_msgs::msg::Control>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<signal_arm_msgs::msg::Control>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<signal_arm_msgs::msg::Control>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SIGNAL_ARM_MSGS__MSG__DETAIL__CONTROL__TRAITS_HPP_
