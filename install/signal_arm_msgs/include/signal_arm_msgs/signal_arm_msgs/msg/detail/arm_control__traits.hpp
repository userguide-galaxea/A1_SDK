...
#ifndef SIGNAL_ARM_MSGS__MSG__DETAIL__ARM_CONTROL__TRAITS_HPP_
#define SIGNAL_ARM_MSGS__MSG__DETAIL__ARM_CONTROL__TRAITS_HPP_
...
inline void to_yaml(
  const signal_arm_msgs::msg::ArmControl & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const signal_arm_msgs::msg::ArmControl & msg)
{
  return signal_arm_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<signal_arm_msgs::msg::ArmControl>()
{
  return "signal_arm_msgs::msg::ArmControl";
}

template<>
inline const char * name<signal_arm_msgs::msg::ArmControl>()
{
  return "signal_arm_msgs/msg/ArmControl";
}

template<>
struct has_fixed_size<signal_arm_msgs::msg::ArmControl>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<signal_arm_msgs::msg::ArmControl>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<signal_arm_msgs::msg::ArmControl>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SIGNAL_ARM_MSGS__MSG__DETAIL__ARM_CONTROL__TRAITS_HPP_
