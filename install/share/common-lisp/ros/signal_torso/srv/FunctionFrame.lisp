...
(cl:in-package signal_torso-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <FunctionFrame-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FunctionFrame-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name signal_torso-srv:<FunctionFrame-request> is deprecated: use signal_torso-srv:FunctionFrame-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <FunctionFrame-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader signal_torso-srv:command-val is deprecated.  Use signal_torso-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FunctionFrame-request>)))
  ...
  "signal_torso/FunctionFrameRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FunctionFrame-request)))
  "Returns string type for a service object of type 'FunctionFrame-request"
  "signal_torso/FunctionFrameRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FunctionFrame-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FunctionFrame-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name signal_torso-srv:<FunctionFrame-response> is deprecated: use signal_torso-srv:FunctionFrame-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <FunctionFrame-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader signal_torso-srv:success-val is deprecated.  Use signal_torso-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <FunctionFrame-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader signal_torso-srv:message-val is deprecated.  Use signal_torso-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FunctionFrame-response>)))
  ...
  "signal_torso/FunctionFrameResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FunctionFrame-response)))
  "Returns string type for a service object of type 'FunctionFrame-response"
  "signal_torso/FunctionFrameResponse")
