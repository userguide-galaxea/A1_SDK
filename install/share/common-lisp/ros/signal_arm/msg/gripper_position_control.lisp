...
(cl:defmethod cl:initialize-instance :after ((m <gripper_position_control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gripper_position_control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name signal_arm-msg:<gripper_position_control> is deprecated: use signal_arm-msg:gripper_position_control instead.")))
...
(cl:defmethod gripper_stroke-val ((m <gripper_position_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader signal_arm-msg:gripper_stroke-val is deprecated.  Use signal_arm-msg:gripper_stroke instead.")
  (gripper_stroke m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<gripper_position_control>)))
  ...
  "signal_arm/gripper_position_control")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'gripper_position_control)))
  "Returns string type for a message object of type 'gripper_position_control"
  "signal_arm/gripper_position_control")
