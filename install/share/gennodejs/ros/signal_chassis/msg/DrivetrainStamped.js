...
class DrivetrainStamped {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Drivetrain.serialize(obj.data, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DrivetrainStamped(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [data]
    data.data = Drivetrain.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DrivetrainStamped(null);
    ...
    if (msg.data !== undefined) {
      resolved.data = Drivetrain.Resolve(msg.data)
    }
    else {
      resolved.data = new Drivetrain()
    }
...
module.exports = DrivetrainStamped;
